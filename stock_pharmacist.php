...
<hr/>
    <div class="tabbed_area">
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				<td><a href="delete_stock.php?stock_id=<?php echo $row['stock_id']?>"><img src="images/delete.jpg" width="24" height="24" border="0" /></a></td>
				<?php
		 }
...
<div id="footer" align="Center"> The Health Hut 2019. Copyright All Rights Reserved</div>
</div>
</body>
</html>
