...
<html>
<head>
<title><?php echo $username;?>-The Health Hut</title>
...
<div id="content">
<div id="header">
<h1><a href="#"><img src="images/lpgo1.jpg"></a> The Health Hut</h1></div>
...
<hr/>
    <div class="tabbed_area">
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				?>
				<td><a href="delete_manager.php?manager_id=<?php echo $row['manager_id']?>"><img src="images/delete.jpg" width="35" height="35" border="0" /></a></td>
				<?php
		 }
        echo "</table>";
?>
